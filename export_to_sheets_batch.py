...
def main() -> None:
    try:
        ...
        alert_success(
            service_name="export-iz-crm-v-sheets",
            message="Выгрузка чатов завершена",
            stats={
                "Всего обработано чатов": total_processed,
        ...
        alert_error(
            service_name="export-iz-crm-v-sheets",
            error=e,
            context="Ошибка при выгрузке чатов из RetailCRM"
        )
        raise
